...
Here are two projects first is covid-19 and second is Nashvill housing data <br>
...
<br>
and nashvill housing data cleaning using sql i used here sql for retrive data
